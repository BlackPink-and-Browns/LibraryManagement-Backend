...
class DepartmentController {
    constructor(private departmentService : DepartmentService , router : Router){
        ...
        router.delete("/remove/:id" ,checkRole([EmployeeRole.HR]), this.removeEmployee.bind(this))
    ...
    async createDepartment(req:Request,res:Response,next:NextFunction) {
        try{
            ...
            const dep = await this.departmentService.createDepartment(createDepartmentDto.name)
    ...
    async addEmployee(req:Request,res:Response) {
        await this.departmentService.removeEmployeeFromDepartmentByID(Number(req.params.id), req.body.employeeid)
        await this.departmentService.addEmployeeToDepartmentByID(Number(req.params.id), req.body.employeeid)
    ...
    async updateDepartment(req:Request,res:Response,next:NextFunction) {
        try{
            ...
            await this.departmentService.updateDepartment(req.params.id , createDepartmentDto.name)
